...
package com.google.android.filament.hellorectangle
...
//        uiHelper.setDesiredSize(screenHeight,screenWidth)
    ...
    private fun createMesh() {
        ...
        val vertexData = ByteBuffer.allocate(vertexCount * vertexSize)
                ...
                // 指定4个顶点(复用2个相同的顶点) , 每个顶点都有一个3D位置：xyz和颜色值：color
                .put(Vertex(-1.0f, -1.0f,  0.0f, 0xffff0000.toInt()))
                .put(Vertex( 1.0f, -1.0f,  0.0f, 0xff00ff00.toInt()))
                .put(Vertex( 1.0f,  1.0f,  0.0f, 0xff0000ff.toInt()))
                .put(Vertex(-1.0f,  1.0f,  0.0f, 0xff000000.toInt()))

...
class CustomViewer {
    ...
    fun loadIndirectLight(context: Context, ibl: String, dirName: String?) {
        val dir = dirName ?: "envs/venetian_crossroads_2k"
        // Create the indirect light source and add it to the scene.
        val buffer = readAsset(context, "${dir}/${ibl}_ibl.ktx")
    ...
    fun loadEnviroment(context: Context, ibl: String, dirName: String?) {
        val dir = dirName ?: "envs/venetian_crossroads_2k"
        // Create the sky box and add it to the scene.
        val buffer = readAsset(context, "${dir}/${ibl}_skybox.ktx")
